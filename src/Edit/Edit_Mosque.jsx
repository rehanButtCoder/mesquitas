...
import { getProvinces, saveMosque, SingleMosque, updateMosque } from '../Services/Mosques';
...
function Add_Mosque() {
    ...
    const onSubmit = async (fData) => {
        ...
        const data = {
            MosqueId: id,
            FilePath: respValues.filePath,
            ProvinceId: fData.provinceId,
            Name: fData.name,
            Fajr: fData.fajr,
            NascerDoSol: fData.nascerDoSol,
            Zuhr: fData.zuhr,
            Asr: fData.asr,
        ...
        const resp = await updateMosque(data)
    ...
    return (
        <div className='dashboardContainer'>
            ...
            <Link className="arrw" to="/mosques">
                ...
                <div>  <h2 className='mainh2'>Edit Mosque</h2></div>
            </Link>
            </div>
                            ...
                            <form>
                                <div className="add_FieldsContainer">
                                    <div className="mosque_Fields">
                                        <select className='addFieldsInput' {...register("provinceId", { required: true })}>
                                            <option disabled selected value="">Provincia</option>
                                            {provinceId.map((x) => {
                                                return <option value={x.provinceId}>{x.name}</option>
                                            })}
                                        </select>
                                        {errors.provinceId && <span className='eror'>Dua is required</span>}
                                    </div>
                                    <div className="mosque_Fields">
                                        <input className='addFieldsInput' type="text" name="uname" placeholder="Mosque Name" {...register("name", { required: true })} />
                                ...
                                <div>
                                    ...
                                    <div className='NamazTimingContainer'>
                                        ...
                                        <div className='namazTimes'>
                                            ...
                                            <div className="setNamazFields">
                                                <input className='namazFields' type="time" name="uname" placeholder="2" {...register("nascerDoSol", { required: true })} />
                                                {errors.nascerDoSol && <span className='eror'>nascer time is required</span>}
                                            </div>
                                            <div className="setNamazFields">
                                ...
                                <div className="MosquebuttonSet">
                                    {(btnLoder ? <div className="relative">
                                        ...
                                        <button to="" className="fBtn saveBtn" >Update</button>
                                    </div> :
                                        <button to="" className="fBtn saveBtn" onClick={handleSubmit(onSubmit)}>Update</button>
                                    )}
                            ...
                            <div className='uplodimg mb-40'>
                                <div className='hiddenField ml120'>
                                    {(imgData ? <img className='mosqueUploaddImg' src={imgData} alt="" /> :
                                        <>
                                            <img id="mleff" className='mosqueUploaddImg' src={respValues.filePath} alt="" />
